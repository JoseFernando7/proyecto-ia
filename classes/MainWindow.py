from PyQt5.QtWidgets import QMainWindow, QWidget, QGridLayout, QVBoxLayout, QLabel, QRadioButton, QPushButton, QHBoxLayout, QSizePolicy
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        right_panel = QWidget()
        right_panel.setGeometry(600, 0, 200, 600)
